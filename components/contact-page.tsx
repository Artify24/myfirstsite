				...
				<div className="max-w-7xl mx-auto text-center">
					<motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
						...
						<p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8">
							Get in touch with us for any queries, support, or to visit our branches across India. We&rsquo;re here to help
			...
			<section className="py-16 px-4 sm:px-6 lg:px-8">
				<div className="max-w-4xl mx-auto">
					...
					>
						...
						<p className="text-slate-600">Fill out the form below and we&aposll get back to you within 24 hours</p>
					</motion.div>
